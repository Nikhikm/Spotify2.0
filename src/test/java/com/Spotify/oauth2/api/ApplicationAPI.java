...
public class ApplicationAPI {
    ...
    public static Response post(Playlist CreatePlaylistPayload) {
        ...
        return RestResource.post(CreatePlaylistPayload,"/users/31ckskvxosw7e3koqevgzakvm7vi/playlists",accessToken);
...
//               .extract().response();
    ...
    {
        return RestResource.get(PlaylistID,"/users/31ckskvxosw7e3koqevgzakvm7vi/playlists/"+PlaylistID,accessToken);
...
//                extract().response();
    ...
    public static Response update(Playlist CreatePlaylistPayload,String PlaylistID){
        return RestResource.update(CreatePlaylistPayload,PlaylistID,"/playlists/"+PlaylistID,accessToken);
