...
public class ApplicationAPI {
  //  static String accessToken ="BQASBZ5OndWhSbF1Jbukooacn-tMAbCYEyDwPVlGRjKWszzoAzH5pcl8IRQJDxntm8Z_QGbcqgRSrGV3s5NmY4QDx03bpMVxhW_vFyJSVlBITuVRt6zwXZM7atTFRgN1xadqkTFI82W1enbQQL0Rb20JRrE1rXtJBodFOHCFx4YOPfK8K9wvzQkCqQ0CHW-fS4Do5wCPV3BnbbWXFh3bfkTSLfosXO2OnKJI5Stim9J4oCAiLOg3XR63K0klVH8te-EY0JBEkmxhWC0hgWQCtPgI8NabHSpgexyuWWuP7mdhLAremwLjacSe";
    public static Response post(Playlist CreatePlaylistPayload) throws FileNotFoundException {

        return RestResource.post(CreatePlaylistPayload,"/users/"+ ConfigLoader.getInstance().getUserID() +PLAYLISTS,getToken());
...
//               .extract().response();
    ...
    public static Response get(String PlaylistID) throws FileNotFoundException {
        return RestResource.get(PlaylistID,"/users/"+ConfigLoader.getInstance().getUserID()+PLAYLISTS+PlaylistID,getToken());
